...
public interface AgentAPI<TConfig extends AgentConfigAPI>
{
     ...
     *  @param inputModelController          The input model to this iteration. This is provided for reference. It must not be modified.
     * @param outputModelControllerToModify The output model for this iteration. The agent is allowed to modify this output model for the next iteration.
     ...
     */
    void modifyEnvironment(ReadOnlyEnvironmentController inputModelController, EnvironmentController outputModelControllerToModify, SimulationIterationAPI iteration, SimulationController simulation, TConfig config) throws Exception;
}
